# -*- coding: utf-8 -*-
"""
Created on Thu May  9 17:48:50 2019
...
"""
本程序实现的功能：
在Oliver2.py中我们训练好并保存了模型的参数，利用这些保存下来的参数来初始化CNN模型，
...
def use_CNN(dataset='olive and my.gif', params_file='params1.pkl', nkerns=[5, 10]):
    ...
    for i in range(face_num):
        if pred[i] != label[i]:
            print('%i picture person is %i, but mis-predicted as person %i' % (i,label[i], pred[i]))
